...
export default function FifteenPuzzleGameLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  return (
    <div className={cn("relative h-dvh", styles.inconsolata)}>
      ...
      <Image alt="Mastroiva Logo" src={mastroviaLogo} className="absolute left-[50%] translate-x-[-50%] top-[80px] opacity-10 px-20 lg:px-0" />
      <div className="bg-radial from-[#00000034] to-[#000000] absolute top-0 left-0 w-full h-full" />
      <div className="bg-[url('/textures/grains.png')] absolute top-0 left-0 w-full h-full pointer-events-none opacity-[0.08]" />
      <div className="absolute top-0 left-0 h-16 border-b w-full flex items-center justify-center">
        Fifteen Puzzle
      </div>
